  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-700 flex gap-2 px-5 py-2 text-white rounder-md font-bold uppercase shadow-md w-full text-center"
          onClick={() => {
        ...
        <button
          type="button"
          className="bg-red-700 flex gap-2 px-5 py-2 text-white rounder-md font-bold uppercase shadow-md w-full text-center mt-3"
